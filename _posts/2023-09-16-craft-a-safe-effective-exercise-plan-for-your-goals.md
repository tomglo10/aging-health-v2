...
image:  "/assets/img/exercising.webp"
...
![Older adults exercising with resistance bands at home](/assets/img/exercising.webp)
...
<li><a href="https://www.mayoclinic.org/healthy-lifestyle/fitness/in-depth/exercise/art-20045506">Mayo Clinic – Exercise Safety</a></li>
</ul>
</div>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What types of exercise are safest for seniors?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Walking, swimming, chair aerobics, resistance band training, and balance exercises are safe and effective for most older adults."
      }
    },
    {
      "@type": "Question",
      "name": "How often should seniors exercise?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most seniors benefit from 150 minutes of moderate activity per week, plus strength and balance training several times weekly."
      }
    },
    {
      "@type": "Question",
      "name": "What safety precautions should older adults follow?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Warm up, stay hydrated, use supportive shoes, avoid high-impact movements, and stop if you feel chest pain, dizziness, or shortness of breath."
      }
    },
    {
      "@type": "Question",
      "name": "Can seniors exercise with chronic conditions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, but they should consult a clinician first, especially if they have heart disease, arthritis, diabetes, or balance issues."
      }
    }
  ]
}
...
.caution{border-left:4px solid #c62828}
.disclaimer{background:#fafafa}
.clinician-note{border-left:4px solid #2e7d32}
</style>
