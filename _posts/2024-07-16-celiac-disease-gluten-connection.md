...
image: "/assets/img/bread-pasta.webp"  
...
![Bread and pasta potential triggers](/assets/img/bread-pasta.webp)  
...
1.  **Serology Tests:** Blood tests detect specific antibodies against gluten.  
2.  **Biopsy:** If blood tests are positive, a biopsy of the small intestine confirms the extent of villi damage.  
3.  **Important Note:** Do not eliminate gluten from the diet before testing. Removing gluten prematurely causes the body to stop producing the antibodies that these tests detect, which can result in false-negative outcomes.  
...
{  
  ...
  "@type": "MedicalWebPage",  
  "name": "Celiac Disease: Unveiling the Gluten Connection",  
  "author": {  
    "@type": "Person",  
    "name": "Tommy T. Douglas"  
  }  
}  
Clinical Citations (2026 Standards)  
Prevalence Data: Global Meta-Analysis of Celiac Disease (2025).  
Genetic Markers: HLA-DQ2/8 Distribution in Autoimmune Pathology, Journal of Clinical Immunology.  
Symptom Overlap: The American Journal of Gastroenterology – Diagnostic Triage for Gluten-Related Disorders.
