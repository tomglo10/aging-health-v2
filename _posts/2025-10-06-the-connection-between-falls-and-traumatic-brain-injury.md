...
image:
  path: /assets/img/senior-woman-walks-with-cane.webp
  alt: "Senior woman walking with a cane in a park"
category: [Cognitive Health, Advocacy]
tags: [tbi, fall-prevention, senior-safety, neuroplasticity, brain-health]
---
...
![Senior Independence]({{ '/assets/img/senior-woman-walks-with-cane.webp' | relative_url }})
{: .normal }
_**Figure 1:** Maintaining independence through physical activity is the first step in lowering the risk of head trauma._
...
Programs like [Tai Chi]({{ '/2024/06/Alzheimer-prevention-lifestyle-tai-chi/' | relative_url }}) and resistance training improve **proprioception**—your brain's ability to know where your body is in space.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why are older adults at higher risk for TBI from falls?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Aging causes brain atrophy and fragile blood vessels, making the brain more vulnerable to injury from even standing-height falls."
      }
    }
  ]
}
