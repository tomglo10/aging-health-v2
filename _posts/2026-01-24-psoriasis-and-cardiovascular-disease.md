...
![Psoriasis and the Heart]({{ '/assets/img/heart.webp' | relative_url }})
{: .normal }
...
If you have psoriasis, you aren't just managing plaques—you are managing your longevity. My goal is to help you catch the warning signs of "Silent Inflammation" before they lead to a cardiac event like mine did. Refer to my [**Big 6 Pillars of Health**]({{ '/posts/big-six-pillars-optimal-aging-health/' | relative_url }}) to see how I build my vascular safety net.
...
The same insulin resistance that complicates psoriasis is now being linked to **Cognitive Decline**—a concept researchers call [**Type 3 Diabetes**]({{ '/posts/brain-health-is-alzheimers-really-type-3-diabetes/' | relative_url }}). When psoriasis and metabolic syndrome overlap, they create a "perfect storm" of accelerated vascular damage.



---

## 📋 The Psoriasis-Heart Advocacy Checklist

Take these three questions to your next physical to ensure your heart is being monitored as closely as your skin:

1.  **hs-CRP Test:** "Can we check my High-Sensitivity C-Reactive Protein? It's a key marker for the systemic inflammation driving my psoriasis."
2.  **Calcium Scoring:** "Given my history of autoimmune inflammation, should we perform a Heart Scan (CAC) to check for silent plaque?"
3.  **Integrated Care:** "Does my cardiologist know my psoriasis is active? We need to coordinate my lipid management with my inflammatory flares."
...
2. *Gelfand JM, et al.* Risk of myocardial infarction in psoriasis. JAMA.
3. *Boehncke WH, et al.* Psoriasis and atherosclerosis. Lancet.

<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Psoriasis and Cardiovascular Disease: What Patients Need to Know",
  "author": {
    "@type": "Person",
    "name": "Tommy T. Douglas"
  },
  "datePublished": "2026-01-24",
  "description": "Explaining the high-stakes link between psoriasis, chronic systemic inflammation, and the risk of heart attack and stroke."
}
</script>
