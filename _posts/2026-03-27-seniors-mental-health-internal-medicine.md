...
image:
  path: /assets/img/senior-mental-health-doctor.webp
...
Seniors’ mental health is deeply intertwined with physical illness, life transitions, and healthcare access. **Internal medicine physicians** are often the **first—and most trusted—point of contact** for detecting stress and [depression in older adults]({{ '/2024/06/tbi-in-older-adults-fall-prevention-recovery.html' | relative_url }}). 
...
![Mental Health Consultation]({{ '/assets/img/senior-mental-health-doctor.webp' | relative_url }})
{: .normal }
...
Aging brings [wisdom and perspective]({{ '/2025/07/wisdom-aging-brain-cognitive-shifts.html' | relative_url }}), but it also brings loss, chronic illness, and profound life changes. For millions of older adults, these changes translate into **stress, depression, and emotional distress**. 
...
Unmanaged stress can worsen [cardiovascular disease]({{ '/2026/01/psoriasis-and-cardiovascular-disease.html' | relative_url }}), diabetes, and immune function, making it a core concern for internal medicine.
...
<script type="application/ld+json">
{
  ...
  "@type": "MedicalWebPage",
  "name": "Seniors’ Mental Health and Internal Medicine",
  "description": "Educational resource on geriatric depression, stress, and the role of internal medicine in integrated care.",
  "about": {
